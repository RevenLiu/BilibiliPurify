...
(function() {
    ...
    const hideSelectors = [
        ...
        'img.official-icon',
        //视频页up主贝壳会员图标
        'span.bili-avatar-nft-icon.bili-avatar-nft--icon-1.bili-avatar-size-nft-48',
        //视频页up主头像框
        ...
        //播放器内弹幕点赞数量
        'div.bpx-player-dm-tip-like-num',
        //播放器内弹幕点赞图标
        'span.bili-danmaku-x-liked-icon',
        'span.bili-danmaku-x-high-icon',
        ...
        //直播页主播昵称下点赞数
        'div.heat-index-scroll-wrapper.heat-index-scroll',
        //直播页chat底部一起玩广告卡
        'div.play-card-box',
        //直播页播放效果评分弹窗
    ...
    if(window.location.hostname == "t.bilibili.com" || window.location.pathname.includes("/opus/")){
        ...
        observeAndExecute('div.b-avatar__layer.center[data-layer-tag="AVATAR_LAYER"]', (el) => {
            //去除了头像框的头像
            if(el.style.width == '37.776px'){
                el.style.width = '48px';
                el.style.height = '48px';
            }

            //某些特殊的超大头像
            if(el.style.width == '76.8px'){
                el.style.width = '60px';
